  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        values.offerDate = values.offerDate ? values.offerDate.format('YYYY-MM-DD') : '';
        // univalence
        console.log(values.offerDate)
...
const WrappedDetailForm = Form.create({
  ...
  mapPropsToFields(props) {
    var arr = [{
          ...
          value: {
            ...props.offerDate, 
            value: props.offerDate && props.offerDate.value ? moment(props.offerDate.value) : null,
          }
        },{
          key: 'remark',
          value: {
