...
// Constants
// ------------------------------------
const ACTION_PREFIX = 'goodsMaintenanceModule::';
...
export const fetchList =  () => {
  return async (dispatch, getState) => {
    ...
    let list = getState().goodsMaintenanceModule.list;
    ...
    if(field3){
      if( field3[0] ) queryParams.undefined = field3[0];
      if( field3[1] ) queryParams.undefined = field3[1];
    }
    ...
    try{
      const resp = await getReq(
        '/proxyHq'+'/huaqian/api/v1/goodsMaintenance/list',
        queryParams
      )
...
export  const fetchDetail =  (id) => {
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await getReq(
        '/proxyHq'+'/huaqian/api/v1/goodsMaintenance/query/'+id,
        {
        }
      )
      const result = await resp.json();
      ...
      dispatch({
        ...
        payload: {
          ...
          univalence: {
            value: data.univalence || null
          },
          offerDate: {
            value: data.offerDate || null
          },
          remark: {
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await deleteReq(
        '/proxyHq'+'/huaqian/api/v1/goodsMaintenance/delete/'+id,
        {
        }
      )
      dispatch({
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = 
        id 
        ? await patchReq(
            '/proxyHq'+'/huaqian/api/v1/goodsMaintenance/update/'+id,
            {
                ...values,
                id: id || '', 
            }
        ...
        : await postReq(
            '/proxyHq'+'/huaqian/api/v1/goodsMaintenance/add',
            {
                ...values,
                id: id || '', 
            }
...
export const updateFields = (fields,type) => {
  return (dispatch, getState) => {
    dispatch({
      type: UPDATE_FIELDS,
      payload: {
        ...getState().goodsMaintenanceModule.fields,
        ...fields
      }
    })
  }
