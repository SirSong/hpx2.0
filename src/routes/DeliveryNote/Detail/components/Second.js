...
class Second extends React.Component {
  constructor(props) {
    ...
    this.columns = [
          ...
          },
          {
            ...
            render: (text, record, index) => this.renderColumns('text',this.state.data, index, 'univalence', text),
          },
          {
            key: 'amount',
            title: '数量',
            dataIndex: 'amount',
            render: (text, record, index) => this.renderColumns('text',this.state.data, index, 'amount', text),
          },
          {
            key: 'total',
            title: '总价',
          ...
          },
          {
            ...
            render: (text, record, index) => this.renderColumns('text',this.state.data, index, 'inventoryAmount', text),
          },
          {
            key: 'deliveryAmount',
            title: '提货数量',
            dataIndex: 'deliveryAmount',
            render: (text, record, index) => this.renderColumns('text',this.state.data, index, 'deliveryAmount', text),
          },
          {
          title: '操作',
          key: 'action',
  ...
  componentWillMount(){
    this.props.fetchList({'tOrderDetailId':this.props.params.id});
  }
  componentWillReceiveProps(nextProps){
    ...
    if (
      ...
      fetchList({'tOrderDetailId':this.props.params.id});
    }
    if (
    ...
    if( type == 'save' ){
      ...
      setTimeout(
        () => {
          ...
          obj.tOrderDetailId = self.props.params.id;
