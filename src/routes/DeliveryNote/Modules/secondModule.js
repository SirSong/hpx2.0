...
// Constants
// ------------------------------------
const ACTION_PREFIX = 'deliveryNoteGoodsModule::';
...
export const fetchList =  (params) => {
  return async (dispatch, getState) => {
    ...
    let list = getState().deliveryNoteGoodsModule.list;
    ...
    try{
      const resp = await getReq(
        '/proxyBiMai'+'/huaqian/api/v1/deliveryNote/getDetail',
        queryParams
      )
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await deleteReq(
        '/proxyBiMai'+'/huaqian/api/v1/deliveryNote/deleteDetail/'+id,
        {
        }
      )
      dispatch({
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = 
        id 
        ? await patchReq(
            '/proxyBiMai'+'/huaqian/api/v1/deliveryNote/updateDetail/'+id,
            {
                ...values,
            }
          )
        : await putReq(
            '/proxyBiMai'+'/huaqian/api/v1/deliveryNote/addDetail',
            {
                ...values,
                id: id || '',
            }
