...
// Constants
// ------------------------------------
const ACTION_PREFIX = 'salesOrderSecondModule::';
...
export const fetchList =  (params) => {
  return async (dispatch, getState) => {
    ...
    let list = getState().salesOrderSecondModule.list;
    ...
    try{
      const resp = await getReq(
        '/proxyBiMai'+'/huaqian/api/v1/salesOrder/getDetail',
        queryParams
      )
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await deleteReq(
        '/proxyBiMai'+'/huaqian/api/v1/salesOrder/deleteDetail/'+id,
        {
        }
      )
      dispatch({
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = 
        id 
        ? await patchReq(
            '/proxyBiMai'+'/huaqian/api/v1/salesOrder/updateDetail/'+id,
            {
                ...values,
            }
          )
        : await putReq(
            '/proxyBiMai'+'/huaqian/api/v1/salesOrder/addDetail',
            {
                ...values,
                id: id || '',
            }
