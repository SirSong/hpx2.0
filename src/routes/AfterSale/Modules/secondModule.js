...
// Constants
// ------------------------------------
const ACTION_PREFIX = 'afterSaleSecondModule::';
...
export const fetchList =  (params) => {
  return async (dispatch, getState) => {
    ...
    let list = getState().afterSaleSecondModule.list;
    ...
    try{
      const resp = await getReq(
        '/proxyBiMai'+'/huaqian/api/v1/afterSale/getDetail',
        queryParams
      )
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await deleteReq(
        '/proxyBiMai'+'/huaqian/api/v1/afterSale/deleteDetail/'+id,
        {
        }
      )
      dispatch({
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = 
        id 
        ? await patchReq(
            '/proxyBiMai'+'/huaqian/api/v1/afterSale/updateDetail/'+id,
            {
                ...values,
            }
          )
        : await putReq(
            '/proxyBiMai'+'/huaqian/api/v1/afterSale/addDetail',
            {
                ...values,
                id: id || '',
            }
