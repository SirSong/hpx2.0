  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await getReq(
        '/proxyBiMai'+'/huaqian/api/v1/afterSale/search',
        queryParams
      )
...
export  const fetchDetail =  (id) => {
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await getReq(
        '/proxyBiMai'+'/huaqian/api/v1/afterSale/get/'+id,
        {
        }
      )
      const result = await resp.json();
      ...
      dispatch({
        ...
        payload: {
          ...
          purchaser: {
            value: data.purchaser || null
          },
          applicationDate: {
            value: data.applicationDate || null
          },
          paymentStatus: {
            value: data.paymentStatus || null
          },
          shipmentsStatus: {
            value: data.shipmentsStatus || null
          },
        }
      })
    }catch(e) {
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await deleteReq(
        '/proxyBiMai'+'/huaqian/api/v1/afterSale/delete/'+id,
        {
        }
      )
      dispatch({
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = 
        id 
        ? await patchReq(
            '/proxyBiMai'+'/huaqian/api/v1/afterSale/update/'+id,
            {
                ...values,
            }
          )
        : await putReq(
            '/proxyBiMai'+'/huaqian/api/v1/afterSale/add',
            {
                ...values,
                id: id || '',
            }
