 /* import fetch, { formPostReq , postReq, getReq, deleteReq, putReq, patchReq }  from '../../../core/fetch';
  ...
  export  const fetchDetail =  (id) => {
    return async (dispatch, getState) => {
      ...
      try{
        const resp = await getReq(
          '/proxy'+'/trade/demanderPro/detail/'+id,
          {
          }
        )
        const result = await resp.json();
    ...
    return async (dispatch, getState) => {
      ...
      try{
        const resp = await deleteReq(
          '/proxy'+'/trade/demanderPro/delete/'+id,
          {
          }
        )
        dispatch({
    ...
    return async (dispatch, getState) => {
      ...
      try{
        const resp = 
          id 
          ? await patchReq(
              '/proxy'+'/trade/demanderPro/save/'+id,
              {
                  ...values,
              }
            )
          : await putReq(
              '/proxy'+'/trade/demanderPro/save',
              {
                  ...values,
                  id: id || '',
              }
  ...
  export const updateFields = (fields,type) => {
    return (dispatch, getState) => {
      dispatch({
        type: UPDATE_FIELDS,
        payload: {
          ...getState().demanderModule.fields,
          ...fields
        }
      })
    }
...
// Constants
// ------------------------------------
const ACTION_PREFIX = 'demanderProModule::';
